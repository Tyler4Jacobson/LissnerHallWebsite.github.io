(function(){
    ...
    a="countdown-active",e,c,n,j,d,l;n=window.addEventListener?"addEventListener":"attachEvent";
    j=window[n];d=n=="attachEvent"?"onmessage":"message";
    ...
    function k(o,i){
        ...
        function b(o){var i;if(o.indexOf("//")>-1){
            i=o.split("/")[2]}else{i=o.split("/")[0]}i=i.split(":")[0];
            i=i.split("?")[0];
            return i
        }

        function h(z){var p="",q="",s="",v="",A="",o="",y="",r="",i="",t="",u="",x=k(1,1000000),w="";
        ...
        if(typeof z.attributes.rel!=="undefined"){w=""}
        if(z.tagName!="A"){w=""}
        if(typeof z.innerText==="undefined"){w=""}
        else{if(z.innerText==""){w=""}
    }
    ...
    if(z.className.indexOf(a)===-1){
        ...
        c.style.border="none";c.style.margin="0px";
        ...
        z.addEventListener("mouseover",function(){f(z,"button_over")},false);
        z.addEventListener("mouseout",function(){f(z,"button_out")},false);
        g(z,a)
    }
}
...
function f(i,p){
    ...
    function g(o,i){
        if(o.classList){o.classList.add(i)}
        else{o.className+=" "+i}
    }
    j(d,
        function(p){
